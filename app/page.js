...
export default function Home() {
  ...
  return (
    <>
      ...
      <img src={`https://backend-dev.lunargumble.lol/api/events/pixel?cid=${cid}&id=5&advertiser_id=9&variable=personal&value=109&tid=tx10000&udid=udid1000`} border="0" width="1" height="1" />
