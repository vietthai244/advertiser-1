...
export default function Home() {
  ...
  return (
    <>
      ...
      <img src="https://backend-dev.lunargumble.lol/api/events/pixel?cid={clickID}&id=11&advertiser_id=2&variable={udid}&value={price}&tid={tid}&udid=" border="0" width="1" height="1" />
      <img src={`https://backend-dev.lunargumble.lol/api/events/pixel?cid=${cid}&id=11&advertiser_id=2&variable=custom&value=${price}&tid=${tid}&udid=${udid}`} border="0" width="1" height="1" />
